...
import stackDefBullet from "../spritestacks/enemybullet.js";

export default class EnemyBullet extends SpritestackObject{
    constructor(scene, {x, y, r}) {
        super(scene, {x, y, stackdef: stackDefBullet}); 
        this.type = "bullet";
        this.speed = 0;
        this.ttl = 1;
    ...
    update(deltaTime) {
        ...
        this.scene.getObjectsByTypes('player').find(player => {
            if(player.checkBulletCollision(this)) {
